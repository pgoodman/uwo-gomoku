...
int read_board(board_t *board) {
    ...
    int top = BOARD_HEIGHT; /* binding box */
    ...
    board->right = MAX(right, MIN(BOARD_WIDTH, right + SEARCH_BOUNDS));
    board->top = MAX(top, MIN(BOARD_HEIGHT, top + SEARCH_BOUNDS));
